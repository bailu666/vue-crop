    ...
    <div class="vicp-wrap">
        ...
        <div class="vicp-step2" v-if="step == 2">
            <div class="vicp-crop">
                <div class="vicp-crop-left" v-show="true">
                    <div class="vicp-img-container">
                        ...
                        <div class="vicp-img-shade vicp-img-shade-3" :style="sourceImgShadeStyle2"></div>
                        <div class="vicp-img-shade vicp-img-shade-4" :style="sourceImgShadeStyle2"></div>
                    </div>
            ...
            <div class="vicp-operate">
                <button @click="upload" @mousedown="ripple">{{ lang.btn.save }}</button>
            </div>
        </div>
        ...
        <div class="vicp-step3" v-if="step == 3">
            ...
            <div class="vicp-operate">
                <button @click="setStep(2)" @mousedown="ripple">{{ lang.btn.back }}</button>
                <button @click="off" @mousedown="ripple">{{ lang.btn.close }}</button>
            </div>
        </div>
